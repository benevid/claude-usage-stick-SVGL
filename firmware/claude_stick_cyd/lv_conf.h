/**
 * lv_conf.h — config do LVGL 9.2 para o Claude Usage Stick (ESP32-2432S028 / CYD).
 *
...
/*=========================
   MEMÓRIA
   Pool interno do LVGL (objetos/estilos). O buffer de render (parcial,
   RAM interna — esta placa não tem PSRAM) é alocado à parte no sketch.
 *=========================*/
